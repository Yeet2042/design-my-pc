...
namespace DesignMyPC.InsideDesign
{
    public partial class cooler : Form
    {
        ...
        private void LoadCard()
        {
            ...
            int endIndex = Math.Min(startIndex + CardPerPage, Global.COOLER_DT.Rows.Count);
            int startOnCard = 1;
            ...
            for (int i = startIndex; i < endIndex; i++)
            {
                ...
                if (panel != null)
                {
                    ...
                    card = new ComponentCard(
                            Global.COOLER_DT.Rows[i]["id"].ToString(),
                            Global.COOLER_DT.Rows[i]["type"].ToString(),
                            Global.COOLER_DT.Rows[i]["brand"].ToString(),
                            Global.COOLER_DT.Rows[i]["serie"].ToString(),
                            Global.COOLER_DT.Rows[i]["model"].ToString(),
                            ...
                            //cooler
                            Global.COOLER_DT.Rows[i]["coolerType"].ToString(),
                            Global.COOLER_DT.Rows[i]["size"].ToString(),
                            Global.COOLER_DT.Rows[i]["tdp"].ToString(),
                            ...
                            Global.COOLER_DT.Rows[i]["price"].ToString()
                        );
                    card.TopLevel = false;
