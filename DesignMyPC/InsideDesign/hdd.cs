...
namespace DesignMyPC.InsideDesign
{
    public partial class hdd : Form
    {
        ...
        private void LoadCard()
        {
            ...
            int endIndex = Math.Min(startIndex + CardPerPage, Global.HDD_DT.Rows.Count);
            int startOnCard = 1;
            ...
            for (int i = startIndex; i < endIndex; i++)
            {
                ...
                if (panel != null)
                {
                    ...
                    card = new ComponentCard(
                            Global.HDD_DT.Rows[i]["id"].ToString(),
                            Global.HDD_DT.Rows[i]["type"].ToString(),
                            Global.HDD_DT.Rows[i]["brand"].ToString(),
                            Global.HDD_DT.Rows[i]["serie"].ToString(),
                            "",
                            ...
                            //hdd
                            Global.HDD_DT.Rows[i]["formFactor"].ToString(),
                            Global.HDD_DT.Rows[i]["size"].ToString(),
                            Global.HDD_DT.Rows[i]["speed"].ToString(),
                            ...
                            Global.HDD_DT.Rows[i]["price"].ToString()
                        );
                    card.TopLevel = false;
