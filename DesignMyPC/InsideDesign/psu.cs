...
namespace DesignMyPC.InsideDesign
{
    public partial class psu : Form
    {
        ...
        private void LoadCard()
        {
            ...
            int endIndex = Math.Min(startIndex + CardPerPage, Global.PSU_DT.Rows.Count);
            int startOnCard = 1;
            ...
            for (int i = startIndex; i < endIndex; i++)
            {
                ...
                if (panel != null)
                {
                    ...
                    card = new ComponentCard(
                            Global.PSU_DT.Rows[i]["id"].ToString(),
                            Global.PSU_DT.Rows[i]["type"].ToString(),
                            Global.PSU_DT.Rows[i]["brand"].ToString(),
                            Global.PSU_DT.Rows[i]["serie"].ToString(),
                            "",
                            ...
                            //psu
                            Global.PSU_DT.Rows[i]["formFactor"].ToString(),
                            Global.PSU_DT.Rows[i]["maxPower"].ToString(),
                            Global.PSU_DT.Rows[i]["cert"].ToString(),
                            ...
                            Global.PSU_DT.Rows[i]["price"].ToString()
                        );
                    card.TopLevel = false;
        ...
        private void psu_Load(object sender, EventArgs e)
        {
            LoadCard();
        }
    }
